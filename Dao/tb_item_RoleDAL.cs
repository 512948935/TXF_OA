...
namespace Dao
{
    public class tb_item_RoleDAL : BaseDAL<tb_item_Role>, Itb_item_RoleDAL
    {
            ...
            try
            {
                ...
                string sql = string.Format(@"SELECT  COUNT(1) CNT
                                               FROM  (SELECT a.ID
                                                            ...
                                                            ,b.ItemName DepName
                                                            ,a.IsDisabled
                                                      FROM   dbo.tb_item_Role a
                                                            LEFT JOIN dbo.tb_item_Department b ON b.ID=a.DepID WHERE a.Marks=1
                                                    ) t WHERE {0} ", where);
